...
const sampleEditors: Editor[] = [
  {
    ...
    role: "chefredakteur",
    imageUrl:
      "https://api.builder.io/api/v1/image/assets/TEMP/cb7a3f7d228c2b24d4a8c45f66083a1da2a07ffe?width=328",
    email: "marc.springer@vol.at",
    articles: "https://vol.at/autor/marc-springer",
    socialLinks: {
  ...
  },
  {
    ...
    imageUrl:
      "https://api.builder.io/api/v1/image/assets/TEMP/7021d0c775fdb02063a284c3030f80e456a06ff4?width=328",
  ...
  },
  {
    ...
    imageUrl:
      "https://api.builder.io/api/v1/image/assets/TEMP/ead7e88a817cd0a2e35c7159c1a54190e4dde77d?width=328",
    email: "pascal.pletsch@vol.at",
    articles: "https://vol.at/autor/pascal-pletsch",
    socialLinks: {
  ...
  },
  {
    ...
    imageUrl:
      "https://api.builder.io/api/v1/image/assets/TEMP/16659db56de7a68a5b111f3a193e8f4450bd3bae?width=328",
    socialLinks: {
  ...
  },
  {
    ...
    imageUrl:
      "https://api.builder.io/api/v1/image/assets/TEMP/2dac341957f2f36f75d0f1fa351def59f7c6a588?width=328",
    socialLinks: {
  ...
  const fetchEditors = async () => {
    try {
      ...
      if (!isUsingSupabase || !supabase) {
        ...
        console.log(
          "Supabase not configured, using sample data. Please connect Supabase to see real editors.",
        );
      ...
      if (result1.error) {
        ...
        const result2 = await supabase
          .from("volat_redaktionsliste_2025")
          .select(
            'id, name, Title, image_url, email, "Artikel zur Person", twitter_url, linkedin_url, instagram_url, website_url, x_url, bluesky_url, created_at',
          )
          .order("created_at", { ascending: true });
        ...
        if (result2.error) {
          ...
          const result3 = await supabase
            .from("volat_redaktionsliste_2025")
            .select(
              'id, name, Title, image_url, email, "Artikel zur Person", x_url, bluesky_url',
            )
            .limit(10);
